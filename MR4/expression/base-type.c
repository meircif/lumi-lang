...
Returncode BaseMethExpression_analyze(BaseMethExpression* self) {
  ...
  CHECK(24, SyntaxTreeCode_get_function(self->_base.code_node, &(function)) )
  self->parent_type = function->parent_type;
  if (!(NULL != self->parent_type)) {
    CHECK(27, SyntaxTreeNode_m_syntax_error_msg(&(self->_base._base), &(String){26, 25, "\"base\" used not in method"}) )
  }
  if (!(NULL != self->parent_type->base_type)) {
    CHECK(29, SyntaxTreeNode_m_syntax_error(&(self->_base._base), &(String){22, 21, "no base type for type"}, function->parent_type->name) )
  }
  if (self->is_call) {
    Int _Int12;
    CHECK(32, TypeData_find_meth(self->parent_type->base_type, function->name, &(self->function), &(_Int12)) )
    if (!(NULL != function)) {
      CHECK(35, SyntaxTreeNode_m_syntax_error(&(self->_base._base), &(String){26, 25, "no base method for method"}, function->name) )
    }
    CHECK(37, Expression_set_simple_type(&(self->_base), &(glob->type_func->_base)) )
    self->_base.result_type->arguments = self->function->arguments;
  }
  else {
    CHECK(40, Expression_set_simple_type(&(self->_base), &(glob->type_base->_base)) )
    CHECK(41, TypeData_m_new_type_instance(self->parent_type, &(self->_base.result_type->sub_type)) )
  }
  return OK;
}
#undef MR_FUNC_NAME
...
Returncode BaseMethExpression_analyze_call(BaseMethExpression* self, FunctionArguments* arguments, Bool* is_function_object) {
  ...
  *self_param = (CallArgument){CallArgument__dtl, NULL, 0, 0, false, NULL, NULL, false, false};
  ...
  if (_BaseMethExpression13 == NULL) RAISE(48)
  *_BaseMethExpression13 = (BaseMethExpression){BaseMethExpression__dtl, NULL, 0, NULL, NULL, false, false, false, false, NULL, NULL};
  _BaseMethExpression13->_base._base._dtl = BaseMethExpression__dtl;
  self_param->value = &(_BaseMethExpression13->_base);
  CHECK(49, TypeData_m_new_type_instance(self->parent_type, &(self_param->value->result_type)) )
  CHECK(50, List_prepend(arguments->parameters, &(self_param->_base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode BaseMethExpression_write(BaseMethExpression* self) {
  if (self->is_call) {
    CHECK(54, SyntaxTreeFunction_write_cname(self->function) )
  }
  else {
    CHECK(56, write(&(String){5, 4, "self"}) )
  }
  return OK;
}
#undef MR_FUNC_NAME
...
Returncode UpCastExpression_init_new(UpCastExpression* self, Int bases, Expression** expression) {
  ...
  *up_cast = (UpCastExpression){UpCastExpression__dtl, NULL, 0, NULL, NULL, false, false, false, NULL, 0};
  ...
  CHECK(66, UpCastExpression_init(up_cast, bases, (*expression)) )
...
Returncode UpCastExpression_init(UpCastExpression* self, Int bases, Expression* expression) {
  ...
  self->bases = bases;
  CHECK(73, TypeInstance_copy_new(self->expression->result_type, &(self->_base.result_type)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode UpCastExpression_write_preactions(UpCastExpression* self) {
  CHECK(76, (self->expression)->_base._dtl[6](self->expression) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode UpCastExpression_write(UpCastExpression* self) {
  ...
  CHECK(80, UpCastExpression_write_pre(self) )
  CHECK(81, (self->expression)->_base._dtl[2](self->expression) )
  CHECK(82, UpCastExpression_write_post(self) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode UpCastExpression_write_dynamic(UpCastExpression* self) {
  CHECK(85, UpCastExpression_write_pre(self) )
  CHECK(86, (self->expression)->_base._dtl[3](self->expression) )
  CHECK(87, UpCastExpression_write_post(self) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode UpCastExpression_write_refman(UpCastExpression* self) {
  ...
  CHECK(91, (self->expression)->_base._dtl[4](self->expression) )
  self->expression->top = false;
  return OK;
}
#undef MR_FUNC_NAME
...
Returncode UpCastExpression_write_post(UpCastExpression* self) {
  CHECK(98, write(&(String){8, 7, "->_base"}) )
  {int n; for (n = (1); n < (self->bases); ++n) {
    CHECK(100, write(&(String){7, 6, "._base"}) )
  }}
...
Returncode TypeExpression_parse_new(TypeExpression* self, String* text, SyntaxTreeCode* code_node, Expression** expression, Char* end) {
  ...
  if (type_instance == NULL) RAISE(108)
  *type_instance = (TypeInstance){NULL, NULL, NULL, NULL, NULL, NULL};
  CHECK(109, TypeInstance_parse_name(type_instance, text, &(code_node->_base), code_node, &((*end))) )
  if ((*end) == '(') {
    InitExpression* expression_init = malloc(sizeof(InitExpression));
    if (expression_init == NULL) RAISE(112)
    *expression_init = (InitExpression){InitExpression__dtl, NULL, 0, NULL, NULL, false, false, false, NULL, NULL, NULL, NULL};
    ...
    CHECK(113, InitExpression_parse(expression_init, type_instance, code_node, &((*end))) )
    (*expression) = &(expression_init->_base);
  }
  else {
    TypeExpression* type_expression = malloc(sizeof(TypeExpression));
    if (type_expression == NULL) RAISE(116)
    *type_expression = (TypeExpression){TypeExpression__dtl, NULL, 0, NULL, NULL, false, false, false};
    ...
    CHECK(117, TypeExpression_parse(type_expression, type_instance) )
...
Returncode TypeExpression_parse(TypeExpression* self, TypeInstance* type_instance) {
  CHECK(121, SyntaxTreeNode_set_location(&(self->_base._base)) )
  CHECK(122, Expression_set_simple_type(&(self->_base), &(glob->type_type->_base)) )
...
Returncode TypeExpression_analyze(TypeExpression* self) {
  CHECK(126, TypeInstance_analyze(self->_base.result_type->sub_type, &(self->_base._base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode TypeExpression_write(TypeExpression* self) {
  CHECK(129, write_cname(self->_base.result_type->sub_type->type_data->name) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
