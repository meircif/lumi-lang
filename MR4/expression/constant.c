...
Func TextExpression__dtl[] = {(void*)SyntaxTreeNode_m_link_types, (void*)SyntaxTreeNode_analyze, (void*)TextExpression_write, (void*)Expression_write_dynamic, (void*)Expression_analyze_call, (void*)Expression_write_preactions};
#endif
...
#endif
#if MR_STAGE == MR_FUNCTIONS
Func IntExpression__dtl[] = {(void*)SyntaxTreeNode_m_link_types, (void*)SyntaxTreeNode_analyze, (void*)TextExpression_write, (void*)Expression_write_dynamic, (void*)Expression_analyze_call, (void*)Expression_write_preactions};
#endif
...
Returncode CharExpression_parse(CharExpression* self, String* text) {
  ...
  if (text->length == 3) {
    ...
    if (text->length == 4) {
      ...
      Bool _Bool21;
      CHECK(97, String_has(&(String){12, 11, "'\"?\\abfnrtv"}, ((text)->values[2]), &(_Bool21)) )
      if (!_Bool21) {
      ...
      if (text->length == 6) {
        ...
        if (ch == 'x') {
          ...
          Bool _Bool22;
          CHECK(104, f_is_hex((&(String){2, 2, (text)->values + (3)}), &(_Bool22)) )
          if (!_Bool22) {
          ...
          Bool _Bool23;
          CHECK(107, f_is_octal((&(String){3, 3, (text)->values + (2)}), &(_Bool23)) )
          if (!_Bool23) {
...
#endif
#if MR_STAGE == MR_FUNCTIONS
Func CharExpression__dtl[] = {(void*)SyntaxTreeNode_m_link_types, (void*)SyntaxTreeNode_analyze, (void*)TextExpression_write, (void*)Expression_write_dynamic, (void*)Expression_analyze_call, (void*)Expression_write_preactions};
#endif
...
Returncode StringExpression_write_preactions(StringExpression* self) {
  ...
  {int index; for (index = (1); index < (self->_base.text->length - 1); ++index) {
    if ((index) < 0 || (index) >= (self->_base.text)->length) RAISE(146)
    if (((self->_base.text)->values[index]) == '\\') {
      index += 1;
    }
    real_length = real_length + 1;
  }}
  CHECK(149, (self->symbol)->_base._dtl[2](self->symbol) )
  CHECK(150, write(&(String){16, 15, "->max_length = "}) )
  CHECK(151, write_int(real_length) )
  CHECK(152, write(&(String){3, 2, ";\n"}) )
  CHECK(153, SyntaxTreeCode_write_spaces(self->_base._base.code_node) )
  CHECK(154, (self->symbol)->_base._dtl[2](self->symbol) )
  CHECK(155, write(&(String){12, 11, "->length = "}) )
  CHECK(156, write_int(real_length - 1) )
  CHECK(157, write(&(String){3, 2, ";\n"}) )
  CHECK(158, SyntaxTreeCode_write_spaces(self->_base._base.code_node) )
  CHECK(159, (self->symbol)->_base._dtl[2](self->symbol) )
  CHECK(160, write(&(String){12, 11, "->values = "}) )
  CHECK(161, write(self->_base.text) )
...
Returncode StringExpression_write(StringExpression* self) {
  CHECK(166, (self->symbol)->_base._dtl[2](self->symbol) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
#endif
#if MR_STAGE == MR_FUNCTIONS
Func StringExpression__dtl[] = {(void*)SyntaxTreeNode_m_link_types, (void*)StringExpression_analyze, (void*)StringExpression_write, (void*)Expression_write_dynamic, (void*)Expression_analyze_call, (void*)StringExpression_write_preactions};
#endif
...
Returncode EmptyExpression_parse_new(EmptyExpression* self, String* text, Expression** expression) {
  ...
  if (_EmptyExpression24 == NULL) RAISE(172)
...
Returncode EmptyExpression_write(EmptyExpression* self) {
  CHECK(178, write(&(String){5, 4, "NULL"}) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode EmptyExpression_write_dynamic(EmptyExpression* self) {
  CHECK(181, (self)->_base._base._dtl[2](self) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
#endif
#if MR_STAGE == MR_FUNCTIONS
Func EmptyExpression__dtl[] = {(void*)SyntaxTreeNode_m_link_types, (void*)SyntaxTreeNode_analyze, (void*)EmptyExpression_write, (void*)EmptyExpression_write_dynamic, (void*)Expression_analyze_call, (void*)Expression_write_preactions};
#endif
