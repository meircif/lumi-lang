...
Returncode SliceExpression_analyze(SliceExpression* self) {
  ...
  CHECK(49, (self->index)->_base._dtl[1](self->index) )
  CHECK(50, SliceExpression_check_index(self, self->index) )
  
  if (NULL != self->second_index) {
    CHECK(53, (self->second_index)->_base._dtl[1](self->second_index) )
...
Returncode SliceExpression_write_preactions(SliceExpression* self) {
  CHECK(71, (self->sequence)->_base._dtl[6](self->sequence) )
  CHECK(72, (self->index)->_base._dtl[6](self->index) )
  
  if (NULL != self->second_index) {
    CHECK(75, (self->second_index)->_base._dtl[6](self->second_index) )
    ...
    CHECK(83, (self->slice_symbol)->_base._base._dtl[2](self->slice_symbol) )
    CHECK(84, write(&(String){15, 14, "_Var.length = "}) )
    CHECK(85, (self->second_index)->_base._dtl[2](self->second_index) )
    ...
    CHECK(94, (self->slice_symbol)->_base._base._dtl[2](self->slice_symbol) )
    CHECK(95, write(&(String){16, 15, "_Var.values = ("}) )
    if (self->sequence->result_type->type_data != &(glob->type_string->_base)) {
      CHECK(97, write(&(String){9, 8, "Byte*)(("}) )
    }
    CHECK(98, (self->sequence)->_base._dtl[2](self->sequence) )
  ...
  CHECK(118, (self->index)->_base._dtl[2](self->index) )
  CHECK(119, write(&(String){11, 10, ") < 0 || ("}) )
  if (NULL != self->second_index) {
    CHECK(121, (self->second_index)->_base._dtl[2](self->second_index) )
    CHECK(122, write(&(String){11, 10, ") < 0 || ("}) )
  }
  CHECK(123, (self->index)->_base._dtl[2](self->index) )
  CHECK(124, write(&(String){3, 2, ") "}) )
  if (NULL != self->second_index) {
    CHECK(126, write(&(String){4, 3, "+ ("}) )
    CHECK(127, (self->second_index)->_base._dtl[2](self->second_index) )
  ...
  CHECK(132, (self->sequence)->_base._dtl[2](self->sequence) )
...
Returncode SliceExpression_write(SliceExpression* self) {
  if (NULL != self->second_index) {
    CHECK(139, (self->slice_symbol)->_base._base._dtl[2](self->slice_symbol) )
    return OK;
  }
  ...
  CHECK(158, (self->sequence)->_base._dtl[2](self->sequence) )
  CHECK(159, write(&(String){11, 10, ")->values)"}) )
  if (self->sequence->result_type->type_data != &(glob->type_string->_base)) {
    CHECK(161, write(&(String){2, 1, ")"}) )
  }
  CHECK(162, write(&(String){2, 1, "["}) )
  CHECK(163, (self->index)->_base._dtl[2](self->index) )
...
Returncode SliceExpression_write_refman(SliceExpression* self) {
  CHECK(174, (self->sequence)->_base._dtl[4](self->sequence) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
