...
Returncode MemberExpression_analyze(MemberExpression* self) {
  ...
  CHECK(90, TypeData_m_find_field(type_data, self->_base.name, &(self->_base.variable), &(self->bases)) )
  if (NULL != self->_base.variable) {
    CHECK(92, TypeInstance_m_copy_new(self->_base.variable->type_instance, &(self->_base._base.result_type)) )
    self->_base._base.assignable = true;
  }
  else {
    CHECK(95, TypeData_m_find_meth(type_data, self->_base.name, &(self->_base.function), &(self->bases)) )
    ...
    CHECK(110, FunctionArguments_m_copy_new(self->_base.function->arguments, &(self->_base._base.result_type->arguments)) )
  }
...
Returncode MemberExpression_analyze_call(MemberExpression* self, FunctionArguments* arguments, Bool* is_function_object) {
  ...
  if (self->instance->result_type->type_data == &(glob->type_type->_base)) {
    ...
    *self_param = (CallArgument){CallArgument__dtl, NULL, 0, 0, false, NULL, NULL, false, false};
    ...
    CHECK(130, List_m_prepend(arguments->parameters, &(self_param->_base)) )
...
Returncode BaseMethExpression_parse_new(BaseMethExpression* self, String* text, SyntaxTreeCode* code_node, Expression** expression) {
  ...
  if (_BaseMethExpression31 == NULL) RAISE(174)
...
Returncode BaseMethExpression_analyze(BaseMethExpression* self) {
  ...
  CHECK(181, SyntaxTreeCode_m_get_parent_type(self->_base.code_node, &(parent_type)) )
  if (!(NULL != parent_type)) {
    CHECK(183, SyntaxTreeNode_m_syntax_error_msg(&(self->_base._base), &(String){26, 25, "\"base\" used not in method"}) )
  }
  if (!(NULL != parent_type->base_type)) {
    CHECK(185, SyntaxTreeNode_m_syntax_error(&(self->_base._base), &(String){22, 21, "no base type for type"}, parent_type->name) )
  }
  CHECK(186, Expression_set_simple_type(&(self->_base), &(glob->type_base->_base)) )
  CHECK(187, TypeData_m_new_type_instance(parent_type, &(self->_base.result_type->sub_type)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode BaseMethExpression_write(BaseMethExpression* self) {
  CHECK(190, write(&(String){5, 4, "self"}) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode UpCastExpression_init_new(UpCastExpression* self, Int bases, Expression** expression) {
  ...
  *up_cast = (UpCastExpression){UpCastExpression__dtl, NULL, 0, NULL, NULL, false, false, false, NULL, 0};
  ...
  CHECK(200, UpCastExpression_init(up_cast, bases, (*expression)) )
...
Returncode UpCastExpression_init(UpCastExpression* self, Int bases, Expression* expression) {
  ...
  self->bases = bases;
  CHECK(206, TypeInstance_m_copy_new(self->expression->result_type, &(self->_base.result_type)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode UpCastExpression_write_preactions(UpCastExpression* self) {
  CHECK(209, (self->expression)->_base._dtl[5](self->expression) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode UpCastExpression_write(UpCastExpression* self) {
  ...
  CHECK(213, UpCastExpression_write_pre(self) )
  CHECK(214, (self->expression)->_base._dtl[2](self->expression) )
  CHECK(215, UpCastExpression_write_post(self) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode UpCastExpression_write_dynamic(UpCastExpression* self) {
  CHECK(218, UpCastExpression_write_pre(self) )
  CHECK(219, (self->expression)->_base._dtl[3](self->expression) )
  CHECK(220, UpCastExpression_write_post(self) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode UpCastExpression_write_post(UpCastExpression* self) {
  CHECK(226, write(&(String){8, 7, "->_base"}) )
  {int n; for (n = (1); n < (self->bases); ++n) {
    CHECK(228, write(&(String){7, 6, "._base"}) )
  }}
...
Returncode TypeExpression_parse_new(TypeExpression* self, String* text, SyntaxTreeCode* code_node, Expression** expression, Char* end) {
  ...
  if (type_instance == NULL) RAISE(236)
  *type_instance = (TypeInstance){NULL, NULL, NULL, NULL, NULL};
  CHECK(237, TypeInstance_parse_name(type_instance, text, &(code_node->_base), code_node, &((*end))) )
  if ((*end) == '(') {
    NewExpression* new_expression = malloc(sizeof(NewExpression));
    if (new_expression == NULL) RAISE(240)
    *new_expression = (NewExpression){NewExpression__dtl, NULL, 0, NULL, NULL, false, false, false, NULL};
    new_expression->_base._base._dtl = NewExpression__dtl;
    CHECK(241, NewExpression_parse(new_expression, type_instance, code_node, &((*end))) )
    (*expression) = &(new_expression->_base);
  }
  else {
    TypeExpression* type_expression = malloc(sizeof(TypeExpression));
    if (type_expression == NULL) RAISE(244)
    *type_expression = (TypeExpression){TypeExpression__dtl, NULL, 0, NULL, NULL, false, false, false};
    ...
    CHECK(245, TypeExpression_parse(type_expression, type_instance) )
...
Returncode TypeExpression_parse(TypeExpression* self, TypeInstance* type_instance) {
  CHECK(249, SyntaxTreeNode_set_location(&(self->_base._base)) )
  CHECK(250, Expression_set_simple_type(&(self->_base), &(glob->type_type->_base)) )
...
Returncode TypeExpression_analyze(TypeExpression* self) {
  CHECK(254, TypeInstance_analyze(self->_base.result_type->sub_type, &(self->_base._base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode TypeExpression_write(TypeExpression* self) {
  CHECK(257, write_cname(self->_base.result_type->sub_type->type_data->name) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode NewExpression_parse(NewExpression* self, TypeInstance* result_type, SyntaxTreeCode* code_node, Char* end) {
  CHECK(267, SyntaxTreeNode_read_expect(&(self->_base._base), &(String){2, 1, ")"}) )
  CHECK(268, read_c(&((*end))) )
  CHECK(269, NewExpression_init(self, result_type, code_node) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode NewExpression_init(NewExpression* self, TypeInstance* result_type, SyntaxTreeCode* code_node) {
  ...
  CHECK(274, SyntaxTreeNode_set_location(&(self->_base._base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode NewExpression_analyze(NewExpression* self) {
  CHECK(277, TypeInstance_analyze(self->_base.result_type, &(self->_base._base)) )
  if (self->_base.result_type->type_data->is_primitive) {
    CHECK(279, SyntaxTreeNode_m_syntax_error(&(self->_base._base), &(String){37, 36, "dynamic allocation of primitive type"}, self->_base.result_type->type_data->name) )
  }
  CHECK(282, TypeInstance_m_check_sequence(self->_base.result_type, &(self->_base._base)) )
  if (!(NULL != self->symbol)) {
    CHECK(284, Expression_add_aux_variable(&(self->_base), ACCESS_NEW, self->_base.result_type, &(self->symbol)) )
  }
  return OK;
}
#undef MR_FUNC_NAME
...
Returncode NewExpression_write_allocation(NewExpression* self) {
  ...
  if (self->_base.result_type->type_data == &(glob->type_array->_base) || self->_base.result_type->type_data == &(glob->type_string->_base)) {
    ...
    CHECK(294, (self->_base.result_type->length)->_base._dtl[5](self->_base.result_type->length) )
  }
  if (self->_base.result_type->type_data == &(glob->type_array->_base) && self->_base.result_type->sub_type->type_data == &(glob->type_string->_base)) {
    ...
    CHECK(299, (self->_base.result_type->sub_type->length)->_base._dtl[5](self->_base.result_type->sub_type->length) )
  }
  CHECK(300, (self->symbol)->_base._dtl[2](self->symbol) )
  ...
  if (self->_base.result_type->type_data == &(glob->type_array->_base)) {
    if (self->_base.result_type->sub_type->type_data == &(glob->type_string->_base)) {
      ...
      CHECK(306, write(&(String){21, 20, "MR_new_string_array("}) )
      CHECK(307, (self->_base.result_type->length)->_base._dtl[2](self->_base.result_type->length) )
      CHECK(308, write(&(String){3, 2, ", "}) )
      CHECK(309, (self->_base.result_type->sub_type->length)->_base._dtl[2](self->_base.result_type->sub_type->length) )
      
    }
    else {
      /* MR_new_array(length, sizeof(SubType)); */
      CHECK(313, write(&(String){14, 13, "MR_new_array("}) )
      CHECK(314, (self->_base.result_type->length)->_base._dtl[2](self->_base.result_type->length) )
      CHECK(315, write(&(String){10, 9, ", sizeof("}) )
    ...
    if (self->_base.result_type->type_data == &(glob->type_string->_base)) {
      ...
      CHECK(321, write(&(String){15, 14, "MR_new_string("}) )
      CHECK(322, (self->_base.result_type->length)->_base._dtl[2](self->_base.result_type->length) )
      
    }
    else {
      /* calloc(1, sizeof(`type`)); */
      CHECK(326, write(&(String){18, 17, "calloc(1, sizeof("}) )
      CHECK(327, write_cname(self->_base.result_type->type_data->name) )
      CHECK(328, write(&(String){2, 1, ")"}) )
    }
  }
  
  CHECK(330, write(&(String){4, 3, ");\n"}) )
  CHECK(331, SyntaxTreeCode_write_spaces(self->_base.code_node) )
  CHECK(332, write(&(String){5, 4, "if ("}) )
  CHECK(333, (self->symbol)->_base._dtl[2](self->symbol) )
  CHECK(334, write(&(String){11, 10, " == NULL) "}) )
  CHECK(335, SyntaxTreeNode_write_raise(&(self->_base._base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode NewExpression_write_preactions(NewExpression* self) {
  CHECK(338, NewExpression_write_allocation(self) )
  CHECK(339, SyntaxTreeCode_write_spaces(self->_base.code_node) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode NewExpression_write(NewExpression* self) {
  if (self->_base.is_statement) {
    CHECK(343, NewExpression_write_allocation(self) )
  }
  else {
    CHECK(345, (self->symbol)->_base._dtl[2](self->symbol) )
  }
  return OK;
}
#undef MR_FUNC_NAME
...
#endif
#if MR_STAGE == MR_FUNCTIONS
Func NewExpression__dtl[] = {(void*)SyntaxTreeNode_m_link_types, (void*)NewExpression_analyze, (void*)NewExpression_write, (void*)Expression_write_dynamic, (void*)Expression_analyze_call, (void*)NewExpression_write_preactions};
#endif
