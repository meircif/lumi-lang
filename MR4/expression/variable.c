...
Returncode VariableExpression_write(VariableExpression* self) {
  CHECK(17, write_cname(self->_base.text) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode BaseMethExpression_parse_new(BaseMethExpression* self, String* text, Expression** expression) {
  ...
  if (_BaseMethExpression25 == NULL) RAISE(23)
...
Returncode BaseMethExpression_write(BaseMethExpression* self) {
  CHECK(27, write(&(String){5, 4, "Base"}) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
#endif
#if MR_STAGE == MR_FUNCTIONS
Func TypeExpression__dtl[] = {(void*)TextExpression_write};
#endif
...
Returncode MemberExpression_parse_new(MemberExpression* self, String* ends, Expression** expression, Char* end) {
  ...
  if (member_expression == NULL) RAISE(50)
  *member_expression = (MemberExpression){MemberExpression__dtl, NULL, NULL, NULL, NULL};
  ...
  CHECK(51, MemberExpression_parse(member_expression, (*expression), ends, &((*end))) )
...
Returncode MemberExpression_parse(MemberExpression* self, Expression* instance, String* ends, Char* end) {
  ...
  CHECK(57, Expression_read_new_value(&(self->_base._base._base), ends, &(self->_base._base.text), &((*end))) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode MemberExpression_write(MemberExpression* self) {
  CHECK(60, (self->instance)->_dtl[0](self->instance) )
  CHECK(61, write(&(String){2, 1, "."}) )
  CHECK(62, VariableExpression_write(&(self->_base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
