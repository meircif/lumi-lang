...
#endif
#if MR_STAGE == MR_DECLARATIONS
Returncode Argument_check_same_as(Argument* self, Argument* other, TypeInstance* instance_type);
#elif MR_STAGE == MR_FUNCTIONS
...
Returncode Argument_check_same_as(Argument* self, Argument* other, TypeInstance* instance_type) {
  ...
  CHECK(38, (other)->_base._dtl[6](other, &(_TypeInstance0)) )
  CHECK(38, (self)->_base._dtl[7](self, _TypeInstance0, instance_type) )
...
#endif
#if MR_STAGE == MR_DECLARATIONS
Returncode Argument_check_same_type_as(Argument* self, TypeInstance* type_instance, TypeInstance* instance_type);
#elif MR_STAGE == MR_FUNCTIONS
...
Returncode Argument_check_same_type_as(Argument* self, TypeInstance* type_instance, TypeInstance* instance_type) {
  ...
  CHECK(43, (self)->_base._dtl[6](self, &(_TypeInstance1)) )
  CHECK(43, TypeInstance_check_equal(_TypeInstance1, type_instance, &(self->_base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_copy_new(FunctionArguments* self, FunctionArguments** new_arguments) {
  ...
  if ((*new_arguments) == NULL) RAISE(69)
  *(*new_arguments) = (FunctionArguments){FunctionArguments__dtl, NULL, 0, NULL, NULL};
  (*new_arguments)->_base._dtl = FunctionArguments__dtl;
  CHECK(70, FunctionArguments_init((*new_arguments)) )
  CHECK(71, FunctionArguments_copy_new_args(self, self->parameters, (*new_arguments)->parameters) )
  CHECK(72, FunctionArguments_copy_new_args(self, self->outputs, (*new_arguments)->outputs) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_copy_new_args(FunctionArguments* self, List* arguments, List* new_arguments) {
  ...
  while (true) {
    ...
    CHECK(79, (((Argument*)(node->item)))->_base._dtl[4](((Argument*)(node->item)), &(_DeclarationArgument2)) )
    CHECK(79, List_add(new_arguments, &(_DeclarationArgument2->_base)) )
    node = node->next;
  }
  return OK;
}
...
Returncode FunctionArguments_init(FunctionArguments* self) {
  CHECK(83, SyntaxTreeNode_set_location(&(self->_base)) )
  self->parameters = malloc(sizeof(List));
  if (self->parameters == NULL) RAISE(84)
  *self->parameters = (List){NULL, NULL};
  self->outputs = malloc(sizeof(List));
  if (self->outputs == NULL) RAISE(85)
...
Returncode FunctionArguments_parse(FunctionArguments* self, ArgumentFactory* argument_factory, Bool is_native, SyntaxTreeCode* code_node, Char* end) {
  CHECK(92, FunctionArguments_init(self) )
  CHECK(93, FunctionArguments_parse_args(self, self->parameters, argument_factory, is_native, code_node, &((*end))) )
  if ((*end) == '-') {
    CHECK(100, SyntaxTreeNode_read_expect(&(self->_base), &(String){3, 2, ">("}) )
    CHECK(101, FunctionArguments_parse_args(self, self->outputs, argument_factory, is_native, code_node, &((*end))) )
  }
  return OK;
}
#undef MR_FUNC_NAME
...
Returncode FunctionArguments_add_self_parameter(FunctionArguments* self, TypeInstance* type_instance) {
  ...
  *self_args = (DeclarationArgument){DeclarationArgument__dtl, NULL, 0, 0, false, false, NULL};
  ...
  if (self_args->variable == NULL) RAISE(111)
  *self_args->variable = (SyntaxTreeVariable){SyntaxTreeVariable__dtl, NULL, 0, NULL, NULL, 0, NULL, NULL, false, false, false};
  ...
  CHECK(112, string_new_copy(&(String){5, 4, "self"}, &(self_args->variable->name)) )
  self_args->variable->type_instance = type_instance;
  CHECK(114, List_prepend(self->parameters, &(self_args->_base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_parse_args(FunctionArguments* self, List* arguments, ArgumentFactory* argument_factory, Bool is_native, SyntaxTreeCode* code_node, Char* end) {
  ...
  Int _Int3;
  CHECK(125, read_until(&(String){3, 2, " )"}, false, &(access_str), &((*end)), &(_Int3)) )
  if ((*end) == '\n' && access_str->length == 0) {
    CHECK(127, SyntaxTreeCode_read_line_break_spaces(code_node) )
    Int _Int4;
    CHECK(128, read_until(&(String){2, 1, " "}, false, &(access_str), &((*end)), &(_Int4)) )
  }
  if ((*end) != ')' || access_str->length > 0) {
    while (true) {
      if (access_str->length == 0) {
        CHECK(132, SyntaxTreeNode_m_syntax_error_c(&(self->_base), &(String){21, 20, "expected access, got"}, (*end)) )
      }
      if ((*end) != ' ') {
        CHECK(134, SyntaxTreeNode_m_syntax_error_c(&(self->_base), &(String){33, 32, "expected space after access, got"}, (*end)) )
      }
      CHECK(136, (argument_factory)->_dtl[0](argument_factory, &(argument)) )
      CHECK(137, List_add(arguments, argument) )
      CHECK(138, Argument_parse(argument, access_str, is_output, is_native, code_node, &((*end))) )
      if (!((*end) == ',')) break;
      CHECK(142, read_c(&((*end))) )
      if ((*end) == '\n') {
        CHECK(144, SyntaxTreeCode_read_line_break_spaces(code_node) )
      }
      else {
        if ((*end) != ' ') {
          CHECK(146, SyntaxTreeNode_m_syntax_error_c(&(self->_base), &(String){42, 41, "expected space or new-line after \",\", got"}, (*end)) )
        }
      }
      Int _Int5;
      CHECK(149, read_until(&(String){2, 1, " "}, false, &(access_str), &((*end)), &(_Int5)) )
    }
  }
...
Returncode FunctionArguments_link_types(FunctionArguments* self) {
  CHECK(153, SyntaxTreeNode_link_children_types(&(self->_base), self->parameters) )
  CHECK(154, SyntaxTreeNode_link_children_types(&(self->_base), self->outputs) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_analyze(FunctionArguments* self) {
  CHECK(157, SyntaxTreeNode_analyze_children(&(self->_base), self->parameters) )
  CHECK(158, SyntaxTreeNode_analyze_children(&(self->_base), self->outputs) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_get_result_type(FunctionArguments* self, Int* access, TypeInstance** result_type) {
  if (NULL != self->outputs->last) {
    CHECK(162, (((Argument*)(self->outputs->last->item)))->_base._dtl[6](((Argument*)(self->outputs->last->item)), &((*result_type))) )
...
Returncode FunctionArguments_get_output(FunctionArguments* self, Expression** output) {
  if (NULL != self->outputs->last) {
    CHECK(170, (((Argument*)(self->outputs->last->item)))->_base._dtl[9](((Argument*)(self->outputs->last->item)), &((*output))) )
  }
  return OK;
}
#undef MR_FUNC_NAME
...
Returncode FunctionArguments_find_variable(FunctionArguments* self, String* name, SyntaxTreeVariable** variable) {
  CHECK(174, FunctionArguments_find_variable_args(self, self->parameters, name, &((*variable))) )
  if (!(NULL != (*variable))) {
    CHECK(176, FunctionArguments_find_variable_args(self, self->outputs, name, &((*variable))) )
  }
  return OK;
}
#undef MR_FUNC_NAME
...
Returncode FunctionArguments_find_variable_args(FunctionArguments* self, List* arguments, String* name, SyntaxTreeVariable** variable) {
  ...
  while (true) {
    ...
    CHECK(184, (((Argument*)(node->item)))->_base._dtl[8](((Argument*)(node->item)), &(_SyntaxTreeVariable6)) )
    Bool _Bool7;
    CHECK(184, SyntaxTreeVariable_find_variable(_SyntaxTreeVariable6, name, &((*variable)), &(_Bool7)) )
    if (!(!_Bool7)) break;
    node = node->next;
  }
  return OK;
...
#endif
#if MR_STAGE == MR_DECLARATIONS
Returncode FunctionArguments_check_same_as(FunctionArguments* self, FunctionArguments* other, TypeInstance* instance_type, Bool* output_ommited);
#elif MR_STAGE == MR_FUNCTIONS
...
Returncode FunctionArguments_check_same_as(FunctionArguments* self, FunctionArguments* other, TypeInstance* instance_type, Bool* output_ommited) {
  ...
  while (true) {
    ...
    CHECK(195, Argument_check_same_as(((Argument*)(my_node->item)), other_node->item, instance_type) )
    my_node = my_node->next;
    other_node = other_node->next;
  }
  if (NULL != my_node) {
    CHECK(199, SyntaxTreeNode_m_syntax_error_msg(&(self->_base), &(String){20, 19, "too many parameters"}) )
  }
  if (NULL != other_node) {
    CHECK(201, SyntaxTreeNode_m_syntax_error_msg(&(self->_base), &(String){19, 18, "too few parameters"}) )
  }
  ...
  while (true) {
    if (!(NULL != my_node &&  NULL !=  other_node)) break;
    CHECK(207, Argument_check_same_as(((Argument*)(my_node->item)), other_node->item, instance_type) )
    my_node = my_node->next;
    other_node = other_node->next;
  }
  if (NULL != my_node) {
    CHECK(211, SyntaxTreeNode_m_syntax_error_msg(&(self->_base), &(String){17, 16, "too many outputs"}) )
  }
  if (NULL != other_node &&  NULL !=  other_node->next) {
    CHECK(213, SyntaxTreeNode_m_syntax_error_msg(&(self->_base), &(String){16, 15, "too few outputs"}) )
  }
...
Returncode FunctionArguments_write_preactions(FunctionArguments* self) {
  CHECK(217, FunctionArguments_write_args_preactions(self, self->parameters) )
  CHECK(218, FunctionArguments_write_args_preactions(self, self->outputs) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_write_args_preactions(FunctionArguments* self, List* arguments) {
  ...
  while (true) {
    if (!(NULL != node)) break;
    CHECK(224, (((Argument*)(node->item)))->_base._dtl[10](((Argument*)(node->item))) )
    node = node->next;
  }
  return OK;
}
...
Returncode FunctionArguments_write(FunctionArguments* self) {
  CHECK(228, FunctionArguments_write_if_decleration(self, true) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_write_call(FunctionArguments* self) {
  CHECK(231, FunctionArguments_write_if_decleration(self, false) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_write_args(FunctionArguments* self, List* arguments) {
  ListNode* node = arguments->first;
  while (true) {
    CHECK(249, (((Argument*)(node->item)))->_base._dtl[3](((Argument*)(node->item))) )
    node = node->next;
    if (!(NULL != node)) break;
...
Returncode FunctionArguments_write_pointer(FunctionArguments* self, String* name) {
  CHECK(255, write(&(String){14, 13, "Returncode (*"}) )
  CHECK(256, write_cname(name) )
  CHECK(257, write(&(String){2, 1, ")"}) )
  CHECK(258, (self)->_base._dtl[3](self) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_write_postactions(FunctionArguments* self) {
  ...
  while (true) {
    if (!(NULL != node)) break;
    CHECK(264, (((Argument*)(node->item)))->_base._dtl[11](((Argument*)(node->item))) )
    node = node->next;
  }
  return OK;
}
