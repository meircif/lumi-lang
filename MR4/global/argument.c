...
Func Argument__dtl[] = {(void*)SyntaxTreeNode_m_link_types, (void*)SyntaxTreeNode_analyze, (void*)SyntaxTreeNode_write, (void*)Argument_m_copy_new, (void*)Argument_parse_value, (void*)Argument_get_type_instance, (void*)Argument_get_variable, (void*)Argument_get_output, (void*)Argument_write_preactions};
#endif
...
Returncode FunctionArguments_m_copy_new(FunctionArguments* self, FunctionArguments** new_arguments) {
  ...
  if ((*new_arguments) == NULL) RAISE(49)
  *(*new_arguments) = (FunctionArguments){FunctionArguments__dtl, NULL, 0, NULL, NULL};
  (*new_arguments)->_base._dtl = FunctionArguments__dtl;
  CHECK(50, FunctionArguments_init((*new_arguments)) )
  CHECK(51, FunctionArguments_m_copy_new_args(self, self->parameters, (*new_arguments)->parameters) )
  CHECK(52, FunctionArguments_m_copy_new_args(self, self->outputs, (*new_arguments)->outputs) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_m_copy_new_args(FunctionArguments* self, List* arguments, List* new_arguments) {
  ...
  while (true) {
    ...
    CHECK(59, (((Argument*)(node->item)))->_base._dtl[3](((Argument*)(node->item)), &(_DeclarationArgument0)) )
    CHECK(59, List_add(new_arguments, &(_DeclarationArgument0->_base)) )
    node = node->next;
  }
  return OK;
}
...
Returncode FunctionArguments_init(FunctionArguments* self) {
  CHECK(63, SyntaxTreeNode_set_location(&(self->_base)) )
  self->parameters = malloc(sizeof(List));
  if (self->parameters == NULL) RAISE(64)
  *self->parameters = (List){NULL, NULL};
  self->outputs = malloc(sizeof(List));
  if (self->outputs == NULL) RAISE(65)
...
Returncode FunctionArguments_parse(FunctionArguments* self, ArgumentFactory* argument_factory, SyntaxTreeCode* code_node, TypeData* parent_type, Char* end) {
  ...
  if (NULL != parent_type) {
    ...
    *self_args = (DeclarationArgument){DeclarationArgument__dtl, NULL, 0, 0, false, NULL};
    ...
    if (self_args->variable == NULL) RAISE(76)
    *self_args->variable = (SyntaxTreeVariable){SyntaxTreeVariable__dtl, NULL, 0, NULL, NULL, 0, NULL, NULL, false};
    ...
    CHECK(77, string_new_copy(&(String){5, 4, "self"}, &(self_args->variable->name)) )
    CHECK(78, TypeData_m_new_type_instance(parent_type, &(self_args->variable->type_instance)) )
    CHECK(79, List_add(self->parameters, &(self_args->_base)) )
  }
  CHECK(80, FunctionArguments_parse_args(self, self->parameters, argument_factory, code_node, &((*end))) )
  if ((*end) == '-') {
    CHECK(83, SyntaxTreeNode_read_expect(&(self->_base), &(String){3, 2, ">("}) )
    CHECK(84, FunctionArguments_parse_args(self, self->outputs, argument_factory, code_node, &((*end))) )
  }
  return OK;
}
#undef MR_FUNC_NAME
  ...
  if ((*end) != ')' || access_str->length > 0) {
    while (true) {
      if (access_str->length == 0) {
        CHECK(102, SyntaxTreeNode_m_syntax_error_c(&(self->_base), &(String){21, 20, "expected access, got"}, (*end)) )
      }
      if ((*end) != ' ') {
        CHECK(104, SyntaxTreeNode_m_syntax_error_c(&(self->_base), &(String){33, 32, "expected space after access, got"}, (*end)) )
      }
      CHECK(106, (argument_factory)->_dtl[0](argument_factory, &(argument)) )
      CHECK(107, List_add(arguments, argument) )
      CHECK(108, Argument_parse(argument, access_str, is_output, code_node, &((*end))) )
      if (!((*end) == ',')) break;
      ...
      if ((*end) == '\n') {
        ...
        if ((*end) != ' ') {
          CHECK(115, SyntaxTreeNode_m_syntax_error_c(&(self->_base), &(String){42, 41, "expected space or new-line after \",\", got"}, (*end)) )
        }
      }
      Int _Int3;
      CHECK(118, read_until(&(String){2, 1, " "}, false, &(access_str), &((*end)), &(_Int3)) )
    }
  }
  CHECK(119, read_c(&((*end))) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_m_link_types(FunctionArguments* self) {
  CHECK(122, SyntaxTreeNode_m_link_children_types(&(self->_base), self->parameters) )
  CHECK(123, SyntaxTreeNode_m_link_children_types(&(self->_base), self->outputs) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_analyze(FunctionArguments* self) {
  CHECK(126, SyntaxTreeNode_analyze_children(&(self->_base), self->parameters) )
  CHECK(127, SyntaxTreeNode_analyze_children(&(self->_base), self->outputs) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_get_result_type(FunctionArguments* self, TypeInstance** result_type) {
  if (NULL != self->outputs->last) {
    CHECK(131, (((Argument*)(self->outputs->last->item)))->_base._dtl[5](((Argument*)(self->outputs->last->item)), &((*result_type))) )
  }
  else {
    (*result_type) = NULL;
  }
...
Returncode FunctionArguments_get_output(FunctionArguments* self, Expression** output) {
  if (NULL != self->outputs->last) {
    CHECK(137, (((Argument*)(self->outputs->last->item)))->_base._dtl[7](((Argument*)(self->outputs->last->item)), &((*output))) )
  }
  else {
    (*output) = NULL;
  }
...
Returncode FunctionArguments_m_find_variable(FunctionArguments* self, String* name, SyntaxTreeVariable** variable) {
  CHECK(143, FunctionArguments_m_find_variable_args(self, self->parameters, name, &((*variable))) )
  if (!(NULL != (*variable))) {
    CHECK(145, FunctionArguments_m_find_variable_args(self, self->outputs, name, &((*variable))) )
  }
  return OK;
}
#undef MR_FUNC_NAME
...
Returncode FunctionArguments_m_find_variable_args(FunctionArguments* self, List* arguments, String* name, SyntaxTreeVariable** variable) {
  ...
  while (true) {
    ...
    CHECK(153, (((Argument*)(node->item)))->_base._dtl[6](((Argument*)(node->item)), &(_SyntaxTreeVariable4)) )
    Bool _Bool5;
    CHECK(153, SyntaxTreeVariable_m_find_variable(_SyntaxTreeVariable4, name, &((*variable)), &(_Bool5)) )
    if (!(!_Bool5)) break;
    node = node->next;
  }
  return OK;
...
Returncode FunctionArguments_m_check_calling(FunctionArguments* self, FunctionArguments* other, Bool* output_ommited) {
  ...
  while (true) {
    ...
    CHECK(163, (((Argument*)(my_node->item)))->_base._dtl[5](((Argument*)(my_node->item)), &(_TypeInstance6)) )
    TypeInstance* _TypeInstance7;
    CHECK(163, (((Argument*)(other_node->item)))->_base._dtl[5](((Argument*)(other_node->item)), &(_TypeInstance7)) )
    CHECK(163, TypeInstance_m_check_assign_to(_TypeInstance6, _TypeInstance7, &(self->_base)) )
    my_node = my_node->next;
    other_node = other_node->next;
  }
  if (NULL != my_node) {
    CHECK(168, SyntaxTreeNode_m_syntax_error_msg(&(self->_base), &(String){20, 19, "too many parameters"}) )
  }
  if (NULL != other_node) {
    CHECK(170, SyntaxTreeNode_m_syntax_error_msg(&(self->_base), &(String){19, 18, "too few parameters"}) )
  }
  ...
  while (true) {
    ...
    CHECK(176, (((Argument*)(other_node->item)))->_base._dtl[5](((Argument*)(other_node->item)), &(_TypeInstance8)) )
    TypeInstance* _TypeInstance9;
    CHECK(176, (((Argument*)(my_node->item)))->_base._dtl[5](((Argument*)(my_node->item)), &(_TypeInstance9)) )
    CHECK(176, TypeInstance_m_check_assign_to(_TypeInstance8, _TypeInstance9, &(self->_base)) )
    my_node = my_node->next;
    other_node = other_node->next;
  }
  if (NULL != my_node) {
    CHECK(181, SyntaxTreeNode_m_syntax_error_msg(&(self->_base), &(String){17, 16, "too many outputs"}) )
  }
  if (NULL != other_node &&  NULL !=  other_node->next) {
    CHECK(183, SyntaxTreeNode_m_syntax_error_msg(&(self->_base), &(String){16, 15, "too few outputs"}) )
  }
...
Returncode FunctionArguments_write_preactions(FunctionArguments* self) {
  CHECK(187, FunctionArguments_write_args_preactions(self, self->parameters) )
  CHECK(188, FunctionArguments_write_args_preactions(self, self->outputs) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode FunctionArguments_write_args_preactions(FunctionArguments* self, List* arguments) {
  ...
  while (true) {
    if (!(NULL != node)) break;
    CHECK(194, (((Argument*)(node->item)))->_base._dtl[8](((Argument*)(node->item))) )
    node = node->next;
  }
  return OK;
}
...
Returncode FunctionArguments_write(FunctionArguments* self, Bool is_decleration) {
  ...
  if (NULL != self->parameters->first) {
    CHECK(201, FunctionArguments_write_args(self, self->parameters) )
  }
  if (NULL != self->outputs->first) {
    if (NULL != self->parameters->first) {
      CHECK(204, write(&(String){3, 2, ", "}) )
    }
    CHECK(205, FunctionArguments_write_args(self, self->outputs) )
  }
  else {
    if (!(NULL != self->parameters->first) && is_decleration) {
      CHECK(207, write(&(String){5, 4, "void"}) )
    }
  }
...
Returncode FunctionArguments_write_args(FunctionArguments* self, List* arguments) {
  ListNode* node = arguments->first;
  while (true) {
    CHECK(213, (((Argument*)(node->item)))->_base._dtl[2](((Argument*)(node->item))) )
    node = node->next;
    if (!(NULL != node)) break;
