...
Returncode Global_init_builtin_types(Global* self) {
  ...
  *self->type_map = (NameMap){NULL, NULL};
  ...
  /* Int */
  CHECK(130, Global_add_builtin_method(self, &(glob->type_int->_base), &(String){4, 3, "str"}, &(arguments)) )
  CHECK(131, Global_add_builtin_parameter(self, arguments, ACCESS_USER, &(glob->type_string->_base), &(String){4, 3, "str"}) )
  
  /* Bool */
  CHECK(135, Global_add_builtin_global_variable(self, &(glob->type_bool->_base), &(String){5, 4, "true"}) )
  CHECK(136, Global_add_builtin_global_variable(self, &(glob->type_bool->_base), &(String){6, 5, "false"}) )
  ...
  CHECK(211, Global_add_builtin_output(self, arguments, ACCESS_VAR, &(glob->type_bool->_base), &(String){7, 6, "is-eof"}) )
  
  CHECK(214, Global_add_builtin_method(self, &(glob->type_file->_base), &(String){5, 4, "putc"}, &(arguments)) )
  CHECK(215, Global_add_builtin_parameter(self, arguments, ACCESS_COPY, &(glob->type_char->_base), &(String){3, 2, "ch"}) )
  
  CHECK(218, Global_add_builtin_method(self, &(glob->type_file->_base), &(String){6, 5, "write"}, &(arguments)) )
  CHECK(219, Global_add_builtin_parameter(self, arguments, ACCESS_USER, &(glob->type_string->_base), &(String){5, 4, "text"}) )
  
  CHECK(222, Global_add_builtin_global_variable(self, &(glob->type_file->_base), &(String){7, 6, "stdout"}) )
  CHECK(223, Global_add_builtin_global_variable(self, &(glob->type_file->_base), &(String){6, 5, "stdin"}) )
  CHECK(224, Global_add_builtin_global_variable(self, &(glob->type_file->_base), &(String){7, 6, "stderr"}) )
  
  /* Sys */
  CHECK(227, Global_add_builtin_field(self, &(glob->type_sys->_base), &(String){5, 4, "argv"}, &(glob->type_array->_base), &(glob->type_string->_base)) )
  
  CHECK(233, Global_add_builtin_method(self, &(glob->type_sys->_base), &(String){6, 5, "print"}, &(arguments)) )
  CHECK(234, Global_add_builtin_parameter(self, arguments, ACCESS_USER, &(glob->type_string->_base), &(String){5, 4, "text"}) )
  
  CHECK(237, Global_add_builtin_method(self, &(glob->type_sys->_base), &(String){8, 7, "println"}, &(arguments)) )
  CHECK(238, Global_add_builtin_parameter(self, arguments, ACCESS_USER, &(glob->type_string->_base), &(String){5, 4, "text"}) )
  
  CHECK(241, Global_add_builtin_method(self, &(glob->type_sys->_base), &(String){8, 7, "getchar"}, &(arguments)) )
  CHECK(242, Global_add_builtin_output(self, arguments, ACCESS_VAR, &(glob->type_char->_base), &(String){3, 2, "ch"}) )
  CHECK(244, Global_add_builtin_output(self, arguments, ACCESS_VAR, &(glob->type_bool->_base), &(String){7, 6, "is-eof"}) )
  
  CHECK(247, Global_add_builtin_method(self, &(glob->type_sys->_base), &(String){8, 7, "getline"}, &(arguments)) )
  CHECK(248, Global_add_builtin_parameter(self, arguments, ACCESS_USER, &(glob->type_string->_base), &(String){5, 4, "line"}) )
  
  CHECK(251, Global_add_builtin_method(self, &(glob->type_sys->_base), &(String){5, 4, "exit"}, &(arguments)) )
  CHECK(252, Global_add_builtin_parameter(self, arguments, ACCESS_COPY, &(glob->type_int->_base), &(String){7, 6, "status"}) )
  
  CHECK(255, Global_add_builtin_method(self, &(glob->type_sys->_base), &(String){7, 6, "system"}, &(arguments)) )
  CHECK(256, Global_add_builtin_parameter(self, arguments, ACCESS_USER, &(glob->type_string->_base), &(String){8, 7, "command"}) )
  CHECK(258, Global_add_builtin_output(self, arguments, ACCESS_VAR, &(glob->type_int->_base), &(String){7, 6, "status"}) )
  
  CHECK(261, Global_add_builtin_method(self, &(glob->type_sys->_base), &(String){7, 6, "getenv"}, &(arguments)) )
  CHECK(262, Global_add_builtin_parameter(self, arguments, ACCESS_USER, &(glob->type_string->_base), &(String){5, 4, "name"}) )
  CHECK(264, Global_add_builtin_parameter(self, arguments, ACCESS_USER, &(glob->type_string->_base), &(String){6, 5, "value"}) )
  CHECK(266, Global_add_builtin_output(self, arguments, ACCESS_VAR, &(glob->type_bool->_base), &(String){7, 6, "exists"}) )
  
  CHECK(269, Global_add_builtin_global_variable(self, &(glob->type_sys->_base), &(String){4, 3, "sys"}) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode Global_add_builtin_type(Global* self, String* name, Bool is_primitive, BuiltinType** type_data) {
  ...
  *(*type_data) = (BuiltinType){BuiltinType__dtl, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, false, false, false};
  ...
  CHECK(274, string_new_copy(name, &((*type_data)->_base.name)) )
  (*type_data)->_base.is_primitive = is_primitive;
  CHECK(276, Global_add_type(self, &((*type_data)->_base)) )
  CHECK(277, List_add(self->root->types, &((*type_data)->_base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode Global_add_type(Global* self, TypeData* type_data) {
  CHECK(280, SyntaxTreeNamespace_init(&(type_data->_base)) )
  CHECK(281, NameMap_add(self->type_map, type_data->name, type_data) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode Global_add_builtin_global_variable(Global* self, TypeData* variable_type, String* name) {
  CHECK(285, Global_add_builtin_variable(self, name, variable_type, NULL, NULL, &(self->root->_base._base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode Global_add_builtin_field(Global* self, TypeData* builtin_type, String* name, TypeData* field_type, TypeData* field_subtype) {
  CHECK(293, Global_add_builtin_variable(self, name, field_type, field_subtype, builtin_type, &(builtin_type->_base._base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode Global_add_builtin_variable(Global* self, String* name, TypeData* variable_type, TypeData* variable_subtype, TypeData* parent_type, SyntaxTreeBranch* branch) {
  ...
  *variable = (BuiltinVariable){BuiltinVariable__dtl, NULL, 0, NULL, NULL, 0, NULL, NULL, false, false, false};
  ...
  CHECK(307, string_new_copy(name, &(variable->_base.name)) )
  ...
  CHECK(312, TypeData_m_new_type_instance(variable_type, &(variable->_base.type_instance)) )
  if (NULL != variable_subtype) {
    CHECK(314, TypeInstance_add_subtype_copy(variable->_base.type_instance, variable_subtype) )
  }
  variable->_base.parent_type = parent_type;
  CHECK(316, List_add(branch->variables, &(variable->_base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode Global_add_builtin_global_function(Global* self, String* name, FunctionArguments** arguments) {
  CHECK(320, Global_add_builtin_function(self, name, NULL, &(glob->root->_base), &((*arguments))) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode Global_add_builtin_method(Global* self, TypeData* builtin_type, String* name, FunctionArguments** arguments) {
  CHECK(325, Global_add_builtin_function(self, name, builtin_type, &(builtin_type->_base), &((*arguments))) )
  CHECK(327, Global_add_builtin_parameter(self, (*arguments), ACCESS_VAR, builtin_type, &(String){5, 4, "self"}) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode Global_add_builtin_function(Global* self, String* name, TypeData* parent_type, SyntaxTreeNamespace* namespace, FunctionArguments** arguments) {
  ...
  *function = (BuiltinFunction){BuiltinFunction__dtl, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, false, NULL, NULL, NULL, NULL, NULL, NULL, 0, false};
  ...
  if (function->_base.arguments == NULL) RAISE(339)
  *function->_base.arguments = (FunctionArguments){FunctionArguments__dtl, NULL, 0, NULL, NULL};
  ...
  CHECK(340, FunctionArguments_init(function->_base.arguments) )
  (*arguments) = function->_base.arguments;
  CHECK(342, List_add(namespace->functions, &(function->_base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode Global_add_builtin_parameter(Global* self, FunctionArguments* arguments, Int access, TypeData* parameter_type, String* name) {
  CHECK(349, Global_add_builtin_argument(self, arguments->parameters, false, access, parameter_type, name) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode Global_add_builtin_output(Global* self, FunctionArguments* arguments, Int access, TypeData* output_type, String* name) {
  CHECK(361, Global_add_builtin_argument(self, arguments->outputs, true, access, output_type, name) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode Global_add_builtin_argument(Global* self, List* argument_list, Bool is_output, Int access, TypeData* argument_type, String* name) {
  ...
  *argument = (DeclarationArgument){DeclarationArgument__dtl, NULL, 0, 0, false, false, NULL};
  ...
  if (argument->variable == NULL) RAISE(377)
  *argument->variable = (SyntaxTreeVariable){SyntaxTreeVariable__dtl, NULL, 0, NULL, NULL, 0, NULL, NULL, false, false, false};
  ...
  CHECK(378, string_new_copy(name, &(argument->variable->name)) )
  argument->variable->access = access;
  CHECK(380, TypeData_m_new_type_instance(argument_type, &(argument->variable->type_instance)) )
  CHECK(382, List_add(argument_list, &(argument->_base)) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
