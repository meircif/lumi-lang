...
Returncode TypeInstance_parse(TypeInstance* self, String* ends, SyntaxTreeNode* node, SyntaxTreeCode* code_node, Char* end) {
  String* name = NULL;
  String* _String120;
  CHECK(31, string_new_concat(ends, &(String){2, 1, "{"}, &(_String120)) )
  Int _Int121;
  CHECK(31, read_until(_String120, false, &(name), &((*end)), &(_Int121)) )
...
Returncode TypeInstance_parse_name(TypeInstance* self, String* name, SyntaxTreeNode* node, SyntaxTreeCode* code_node, Char* end) {
  ...
  if ((*end) == '{') {
    Bool _Bool122;
    CHECK(42, String_equal(self->name, &(String){5, 4, "Func"}, &(_Bool122)) )
    if (_Bool122) {
      CHECK(43, read_c(&((*end))) )
      if ((*end) != '(') {
      ...
      *self->arguments = (FunctionArguments){FunctionArguments__dtl, NULL, 0, NULL, NULL};
      ...
      CHECK(49, FunctionArguments_parse(self->arguments, &(argument_factory->_base), NULL, &((*end))) )
    }
    else {
      Bool _Bool123;
      CHECK(50, String_equal(self->name, &(String){7, 6, "String"}, &(_Bool123)) )
      if (NULL != code_node && _Bool123) {
        ...
        Bool _Bool124;
        CHECK(56, String_equal(self->name, &(String){6, 5, "Array"}, &(_Bool124)) )
        if (NULL != code_node && _Bool124) {
...
Returncode TypeInstance_check_assign_to(TypeInstance* self, TypeInstance* target, SyntaxTreeNode* node, Int* bases) {
  ...
  while (true) {
    Bool _Bool125;
    CHECK(122, TypeData_m_is_same(target->type_data, base_type, &(_Bool125)) )
    if (!(!_Bool125)) break;
  ...
  if (NULL != self->arguments) {
    Bool _Bool126;
    CHECK(133, FunctionArguments_check_same_as(self->arguments, target->arguments, &(_Bool126)) )
    if (_Bool126) {
