...
Returncode SyntaxTreeFunction_parse_arguments(SyntaxTreeFunction* self, Bool is_native, Char* end) {
  ...
  *self->arguments = (FunctionArguments){FunctionArguments__dtl, NULL, 0, NULL, NULL};
  ...
  if (NULL != self->parent_type) {
    ...
    CHECK(62, TypeData_m_new_type_instance(self->parent_type, &(_TypeInstance117)) )
    CHECK(62, FunctionArguments_add_self_parameter(self->arguments, _TypeInstance117) )
  }
  return OK;
}
#undef MR_FUNC_NAME
...
Returncode SyntaxTreeFunction_check_name(SyntaxTreeFunction* self) {
  Bool _Bool118;
  CHECK(66, f_is_legal_name(self->name, false, &(_Bool118)) )
  if (!_Bool118) {
  ...
  if (NULL != self->parent_type) {
    ...
    Int _Int119;
    CHECK(70, TypeData_find_meth(self->parent_type, self->name, &(meth), &(_Int119)) )
    if (NULL != meth) {
    ...
    Int _Int120;
    CHECK(74, TypeData_find_field(self->parent_type, self->name, &(field), &(_Int120)) )
    if (NULL != field) {
    ...
    CHECK(79, SyntaxTreeNamespace_find_function(&(glob->root->_base), self->name, &(_SyntaxTreeFunction121)) )
    ...
    CHECK(81, (glob->root)->_base._base._base._dtl[5](glob->root, self->name, &(_SyntaxTreeVariable122)) )
...
Returncode SyntaxTreeFunction_write_setup(SyntaxTreeFunction* self) {
  ...
  while (true) {
    ...
    if (((Argument*)(node->item))->access == ACCESS_USER || ((Argument*)(node->item))->access == ACCESS_OWNER) {
      ...
      CHECK(185, (((Argument*)(node->item)))->_base._dtl[8](((Argument*)(node->item)), &(_SyntaxTreeVariable123)) )
      CHECK(185, write_cname(_SyntaxTreeVariable123->name) )
...
Returncode SyntaxTreeFunction_write_cleanup(SyntaxTreeFunction* self) {
  ...
  while (true) {
    ...
    if (((Argument*)(param_node->item))->access == ACCESS_USER || ((Argument*)(param_node->item))->access == ACCESS_OWNER) {
      ...
      CHECK(211, (((Argument*)(param_node->item)))->_base._dtl[8](((Argument*)(param_node->item)), &(_SyntaxTreeVariable124)) )
      CHECK(211, write_cname(_SyntaxTreeVariable124->name) )
...
Returncode DeclarationArgumentFactory_m_new_argument(DeclarationArgumentFactory* self, Argument** new_argument) {
  DeclarationArgument* _DeclarationArgument125 = malloc(sizeof(DeclarationArgument));
  if (_DeclarationArgument125 == NULL) RAISE(395)
  *_DeclarationArgument125 = (DeclarationArgument){DeclarationArgument__dtl, NULL, 0, 0, false, false, NULL};
  _DeclarationArgument125->_base._base._dtl = DeclarationArgument__dtl;
  (*new_argument) = &(_DeclarationArgument125->_base);
  return OK;
}
#undef MR_FUNC_NAME
#endif
