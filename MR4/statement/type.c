  ...
  if ((*end) == '{') {
    ...
    *self->parameters = (List){NULL, NULL};
    while (true) {
      ...
      Bool _Bool136;
      CHECK(30, f_is_legal_name(name, true, &(_Bool136)) )
      if (!_Bool136) {
...
Returncode TypeData_add_type(TypeData* self) {
  Bool _Bool137;
  CHECK(50, f_is_legal_name(self->name, true, &(_Bool137)) )
  if (!_Bool137) {
  ...
  CHECK(52, NameMap_find(glob->type_map, self->name, (void**)&(_TypeData138)) )
...
Returncode TypeData_parse_child(TypeData* self, String* keyword, Char* end) {
  Bool _Bool139;
  CHECK(57, SyntaxTreeNamespace_parse_if_function(&(self->_base), keyword, self, &((*end)), &(_Bool139)) )
  if (_Bool139) {
    return OK;
  }
  
  Bool _Bool140;
  CHECK(60, String_equal(keyword, &(String){4, 3, "new"}, &(_Bool140)) )
  if (_Bool140) {
    if ((*end) != '(') {
...
Returncode TypeData_find_field(TypeData* self, String* name, SyntaxTreeVariable** field, Int* bases) {
  ...
  while (true) {
    ...
    while (true) {
      if (!(NULL != child)) break;
      Bool _Bool141;
      CHECK(110, String_equal(((SyntaxTreeVariable*)(child->item))->name, name, &(_Bool141)) )
      if (_Bool141) {
...
Returncode TypeData_find_meth(TypeData* self, String* name, SyntaxTreeFunction** method, Int* bases) {
  ...
  while (true) {
    ...
    while (true) {
      if (!(NULL != child)) break;
      Bool _Bool142;
      CHECK(128, String_equal(((SyntaxTreeFunction*)(child->item))->name, name, &(_Bool142)) )
      if (_Bool142) {
...
Returncode TypeData_analyze(TypeData* self) {
  ...
  Bool _Bool143;
  CHECK(174, List_m_is_empty(self->_base._base.variables, &(_Bool143)) )
...
Returncode TypeData_write_dynamic_init(TypeData* self, TypeData* type_data) {
  ...
  while (true) {
    ...
    SyntaxTreeFunction* method = NULL;
    Int _Int144;
    CHECK(279, TypeData_find_meth(self, ((SyntaxTreeFunction*)(child->value))->name, &(method), &(_Int144)) )
