...
Returncode TypeData_find_field(TypeData* self, String* name, SyntaxTreeVariable** field, Int* bases) {
  ...
  while (true) {
    ...
    while (true) {
      if (!(NULL != child)) break;
      Bool _Bool139;
      CHECK(95, String_equal(((SyntaxTreeVariable*)(child->item))->name, name, &(_Bool139)) )
      if (_Bool139) {
...
Returncode TypeData_find_meth(TypeData* self, String* name, SyntaxTreeFunction** method, Int* bases) {
  ...
  while (true) {
    ...
    while (true) {
      if (!(NULL != child)) break;
      Bool _Bool140;
      CHECK(113, String_equal(((SyntaxTreeFunction*)(child->item))->name, name, &(_Bool140)) )
      if (_Bool140) {
...
Returncode TypeData_analyze(TypeData* self) {
  ...
  Bool _Bool141;
  CHECK(159, List_m_is_empty(self->_base._base.variables, &(_Bool141)) )
...
Returncode TypeData_write_dynamic_init(TypeData* self, TypeData* type_data) {
  ...
  while (true) {
    ...
    SyntaxTreeFunction* method = NULL;
    Int _Int142;
    CHECK(246, TypeData_find_meth(self, ((SyntaxTreeFunction*)(child->value))->name, &(method), &(_Int142)) )
    if (not_first) {
