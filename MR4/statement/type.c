  ...
  if ((*end) == '{') {
    ...
    *self->parameters = (List){NULL, NULL};
    while (true) {
      ...
      Bool _Bool127;
      CHECK(29, f_is_legal_name(name, true, &(_Bool127)) )
      if (!_Bool127) {
...
Returncode TypeData_add_type(TypeData* self) {
  Bool _Bool128;
  CHECK(49, f_is_legal_name(self->name, true, &(_Bool128)) )
  if (!_Bool128) {
  ...
  CHECK(51, NameMap_find(glob->type_map, self->name, (void**)&(_TypeData129)) )
  if (NULL != _TypeData129) {
...
Returncode TypeData_parse_child(TypeData* self, String* keyword, Char* end) {
  Bool _Bool130;
  CHECK(56, SyntaxTreeNamespace_parse_if_function(&(self->_base), keyword, self, &((*end)), &(_Bool130)) )
  if (_Bool130) {
    return OK;
  }
  
  Bool _Bool131;
  CHECK(59, String_equal(keyword, &(String){4, 3, "new"}, &(_Bool131)) )
  if (_Bool131) {
    if ((*end) != '(') {
...
Returncode TypeData_find_field(TypeData* self, String* name, SyntaxTreeVariable** field, Int* bases) {
  ...
  while (true) {
    ...
    while (true) {
      if (!(NULL != child)) break;
      Bool _Bool132;
      CHECK(95, String_equal(((SyntaxTreeVariable*)(child->item))->name, name, &(_Bool132)) )
      if (_Bool132) {
...
Returncode TypeData_find_meth(TypeData* self, String* name, SyntaxTreeFunction** method, Int* bases) {
  ...
  while (true) {
    ...
    while (true) {
      if (!(NULL != child)) break;
      Bool _Bool133;
      CHECK(113, String_equal(((SyntaxTreeFunction*)(child->item))->name, name, &(_Bool133)) )
      if (_Bool133) {
...
Returncode TypeData_analyze(TypeData* self) {
  ...
  Bool _Bool134;
  CHECK(159, List_m_is_empty(self->_base._base.variables, &(_Bool134)) )
  if (!(NULL != self->base_type) && _Bool134) {
...
Returncode TypeData_write_dynamic_init(TypeData* self, TypeData* type_data) {
  ...
  while (true) {
    ...
    SyntaxTreeFunction* method = NULL;
    Int _Int135;
    CHECK(246, TypeData_find_meth(self, ((SyntaxTreeFunction*)(child->value))->name, &(method), &(_Int135)) )
    if (not_first) {
...
Func TypeData__dtl[] = {(void*)TypeData_get_parent_type, (void*)TypeData_link_types, (void*)TypeData_analyze, (void*)TypeData_write, (void*)TypeData_parse_child, (void*)SyntaxTreeBranch_find_variable, (void*)TypeData_write_declaration, (void*)TypeData_write_me};
#endif
