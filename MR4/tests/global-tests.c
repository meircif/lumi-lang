...
Returncode f_assert_string_slice(String* expected, String* actual, Int start, Int length) {
  ...
  if (actual->length >= start + length) {
    ...
    Bool _Bool124;
    CHECK(86, String_equal(actual_slice, expected, &(_Bool124)) )
    if (_Bool124) {
      return OK;
    }
  }
...
Returncode test_list() {
  ...
  String* _String125;
  CHECK(105, List_m_pop(list, (void**)&(_String125)) )
  TEST_ASSERT(105, !(NULL != _String125))
  String* _String126;
  CHECK(106, string_new_copy(&(String){7, 6, "value1"}, &(_String126)) )
  CHECK(106, List_add(list, _String126) )
  String* _String127;
  CHECK(107, string_new_copy(&(String){7, 6, "value2"}, &(_String127)) )
  CHECK(107, List_add(list, _String127) )
  String* _String128;
  CHECK(108, string_new_copy(&(String){7, 6, "value3"}, &(_String128)) )
  CHECK(108, List_add(list, _String128) )
  String* _String129;
  CHECK(109, List_m_pop(list, (void**)&(_String129)) )
  CHECK(109, f_assert_string(&(String){7, 6, "value1"}, _String129) )
  String* _String130;
  CHECK(110, List_m_pop(list, (void**)&(_String130)) )
  CHECK(110, f_assert_string(&(String){7, 6, "value2"}, _String130) )
  String* _String131;
  CHECK(111, List_m_pop(list, (void**)&(_String131)) )
  CHECK(111, f_assert_string(&(String){7, 6, "value3"}, _String131) )
  String* _String132;
  CHECK(112, List_m_pop(list, (void**)&(_String132)) )
  TEST_ASSERT(112, !(NULL != _String132))
  return OK;
}
#undef MR_FUNC_NAME
#endif
...
Returncode test_name_map() {
  ...
  String* _String133;
  CHECK(119, NameMap_find(map, &(String){6, 5, "name1"}, (void**)&(_String133)) )
  TEST_ASSERT(119, !(NULL != _String133))
  CHECK(120, NameMap_add(map, &(String){6, 5, "name1"}, &(String){7, 6, "value1"}) )
  String* _String134;
  CHECK(121, NameMap_find(map, &(String){6, 5, "name1"}, (void**)&(_String134)) )
  CHECK(121, f_assert_string(&(String){7, 6, "value1"}, _String134) )
  String* _String135;
  CHECK(122, NameMap_find(map, &(String){6, 5, "name2"}, (void**)&(_String135)) )
  TEST_ASSERT(122, !(NULL != _String135))
  CHECK(123, NameMap_add(map, &(String){6, 5, "name2"}, &(String){7, 6, "value2"}) )
  String* _String136;
  CHECK(124, NameMap_find(map, &(String){6, 5, "name1"}, (void**)&(_String136)) )
  CHECK(124, f_assert_string(&(String){7, 6, "value1"}, _String136) )
  String* _String137;
  CHECK(125, NameMap_find(map, &(String){6, 5, "name2"}, (void**)&(_String137)) )
  CHECK(125, f_assert_string(&(String){7, 6, "value2"}, _String137) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
