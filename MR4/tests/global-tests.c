...
Returncode test_name_map() {
  ...
  String* _String163;
  CHECK(279, NameMap_find(map, &(String){6, 5, "name1"}, (void**)&(_String163)) )
  TEST_ASSERT(279, !(NULL != _String163))
  CHECK(280, NameMap_add(map, &(String){6, 5, "name1"}, &(String){7, 6, "value1"}) )
  String* _String164;
  CHECK(281, NameMap_find(map, &(String){6, 5, "name1"}, (void**)&(_String164)) )
  CHECK(281, f_assert_string(&(String){7, 6, "value1"}, _String164) )
  String* _String165;
  CHECK(282, NameMap_find(map, &(String){6, 5, "name2"}, (void**)&(_String165)) )
  TEST_ASSERT(282, !(NULL != _String165))
  CHECK(283, NameMap_add(map, &(String){6, 5, "name2"}, &(String){7, 6, "value2"}) )
  String* _String166;
  CHECK(284, NameMap_find(map, &(String){6, 5, "name1"}, (void**)&(_String166)) )
  CHECK(284, f_assert_string(&(String){7, 6, "value1"}, _String166) )
  String* _String167;
  CHECK(285, NameMap_find(map, &(String){6, 5, "name2"}, (void**)&(_String167)) )
  CHECK(285, f_assert_string(&(String){7, 6, "value2"}, _String167) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
