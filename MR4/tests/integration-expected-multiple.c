...
Returncode test_dynamic_type_parameters(void) {
  ...
  Data dmid_Var = {0};
  Data* dmid = NULL;
  RefManager* dmid_Refman = NULL;
  TopType ttop_Var = {{{0}}};
  TopType* ttop = NULL;
  RefManager* ttop_Refman = NULL;
  TopType_Dynamic* ttop_Dynamic = &TopType_dynamic;
  BaseType* tbase = NULL;
  RefManager* tbase_Refman = NULL;
  ...
  dmid->item_Dynamic = &(ttop_Dynamic->_base);
  ...
  CHECK(117, Data_set(dmid, dmid_Refman, &(ttop->_base), ttop_Refman, &(ttop_Dynamic->_base), NULL, NULL) )
  MR_dec_ref(tbase_Refman);
  tbase_Refman = NULL;
  MR_inc_ref(tbase_Refman);
  tbase_Dynamic = NULL;
