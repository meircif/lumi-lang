...
static char* _mr_file26_name = "mr4-compiler.3.mr";
#endif
...
Returncode func(Array* argv) {
  ...
  CHECK(19, (glob->root)->_base._base._base._dtl[1](glob->root) )
  CHECK(20, (glob->root)->_base._base._base._dtl[2](glob->root) )
  return OK;
}
#undef MR_FUNC_NAME
#endif
