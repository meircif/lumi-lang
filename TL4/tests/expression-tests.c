...
static char* _lumi_file30_name = "tests/expression-tests.3.lm";
#endif
...
Returncode test_code_setup(String* input_text) {
  ...
  CHECK(21, String_concat(mock_input_file_text, input_text) )
  return OK;
}
...
Returncode test_code(String* input_text, String* expected_output) {
  ...
  CHECK(30, write_syntax_tree(false) )
  ...
  CHECK(43, f_assert_string_slice(expected_header, mock_output_file_text, 0, expected_header->length, false) )
  if (was_first) {
    CHECK(50, set_test_file_name(filename, &(String){12, 11, "code-header"}, &(String){10, 9, ".actual.c"}) )
    CHECK(51, file_open_write(filename, &(code_header)) )
    if (tests_passed) {
      {int n; for (n = (0); n < (expected_header->length); ++n) {
        if ((n) < 0 || (n) >= (mock_output_file_text)->length) RAISE(54)
        CHECK(54, File_putc(code_header, ((mock_output_file_text)->values[n])) )
      }}
    }
    else {
      {int n; for (n = (0); n < (mock_output_file_text->length); ++n) {
        if ((n) < 0 || (n) >= (mock_output_file_text)->length) RAISE(57)
        CHECK(57, File_putc(code_header, ((mock_output_file_text)->values[n])) )
      }}
    }
    CHECK(58, File_close(code_header) )
  ...
  Int footer_start = 0;
  if ((expected_header->length) < 0 || (mock_output_file_text->length - expected_header->length) < 0 || (expected_header->length) + (mock_output_file_text->length - expected_header->length) > (mock_output_file_text)->length) RAISE(64)
  ...
  CHECK(65, String_find(mock_output_no_header, &(String){20, 19, "\nLUMI_cleanup:\n    "}, &(footer_start)) )
  if (footer_start >= mock_output_no_header->length) {
    CHECK(67, Sys_print(sys, mock_output_no_header) )
    code_header_valid = false;
    RAISE(69)
  }
  CHECK(70, f_assert_string_slice(expected_output, mock_output_no_header, 0, footer_start, true) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_code_error(String* input_text, String* expected_error) {
  ...
  CHECK(81, test_code_setup(input_text) )
  mock_print_active = true;
  _trace_stream = NULL;
  do {
#undef RETURN_ERROR
#define RETURN_ERROR(value) break
    CHECK(83, write_syntax_tree(false) );
#undef RETURN_ERROR
#define RETURN_ERROR(value) return value
  ...
  CHECK(86, f_assert_string_slice(expected_header, mock_print_text, 0, expected_header->length, false) )
  ...
  CHECK(93, f_assert_string_slice(expected_error, mock_print_text, expected_header->length + 3, mock_print_text->length - expected_header->length - 4, true) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_int_expression() {
  CHECK(102, test_new_file(&(String){17, 16, "expression-tests"}, &(String){20, 19, "test-int-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_char_expression() {
  CHECK(106, test_from_file(&(String){21, 20, "test-char-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
#if LUMI_STAGE == LUMI_DECLARATIONS
Returncode test_long_expression();
#elif LUMI_STAGE == LUMI_FUNCTIONS
static char* _func_name_test_long_expression = "test-long-expression";
#define LUMI_FUNC_NAME _func_name_test_long_expression
Returncode test_long_expression() {
  CHECK(110, test_from_file(&(String){21, 20, "test-long-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_string_expression() {
  CHECK(114, test_from_file(&(String){23, 22, "test-string-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_empty_expression() {
  CHECK(118, test_from_file(&(String){22, 21, "test-empty-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_member_expression() {
  CHECK(122, test_from_file(&(String){23, 22, "test-member-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_slice_expression() {
  CHECK(126, test_from_file(&(String){22, 21, "test-slice-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_call_expression() {
  CHECK(130, test_from_file(&(String){21, 20, "test-call-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_type_expression() {
  CHECK(134, test_from_file(&(String){21, 20, "test-type-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_base_expression() {
  CHECK(138, test_from_file(&(String){21, 20, "test-base-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_block_expression() {
  CHECK(142, test_from_file(&(String){22, 21, "test-block-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_unary_expression() {
  CHECK(146, test_from_file(&(String){22, 21, "test-unary-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_binary_expression() {
  CHECK(150, test_from_file(&(String){23, 22, "test-binary-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_question_expression() {
  CHECK(154, test_from_file(&(String){25, 24, "test-question-expression"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_dynamic() {
  CHECK(158, test_from_file(&(String){13, 12, "test-dynamic"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_function_object() {
  CHECK(162, test_from_file(&(String){21, 20, "test-function-object"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
...
Returncode test_builtin() {
  CHECK(166, test_from_file(&(String){13, 12, "test-builtin"}) )
  return OK;
}
#undef LUMI_FUNC_NAME
#endif
