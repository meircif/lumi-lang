...
#define LUMI_FUNC_NAME _func_name_St_empty_parse
...
#define LUMI_FUNC_NAME _func_name_St_empty_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_empty_analyze
...
#define LUMI_FUNC_NAME _func_name_St_empty_write
...
#define LUMI_FUNC_NAME _func_name_St_comment_parse
...
#define LUMI_FUNC_NAME _func_name_St_comment_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_comment_analyze
...
#define LUMI_FUNC_NAME _func_name_St_comment_write
...
#define LUMI_FUNC_NAME _func_name_St_multi_comment_parse
...
#define LUMI_FUNC_NAME _func_name_St_multi_comment_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_multi_comment_analyze
...
#define LUMI_FUNC_NAME _func_name_St_multi_comment_write
...
#define LUMI_FUNC_NAME _func_name_St_documentation_parse
...
#define LUMI_FUNC_NAME _func_name_St_documentation_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_documentation_analyze
...
#define LUMI_FUNC_NAME _func_name_St_documentation_write
...
#define LUMI_FUNC_NAME _func_name_St_multi_documentation_parse
...
#define LUMI_FUNC_NAME _func_name_St_multi_documentation_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_multi_documentation_analyze
...
#define LUMI_FUNC_NAME _func_name_St_multi_documentation_write
...
#define LUMI_FUNC_NAME _func_name_f_parse_new_node
...
#define LUMI_FUNC_NAME _func_name_St_node_parse_line
...
#define LUMI_FUNC_NAME _func_name_St_node_parse_block
...
#define LUMI_FUNC_NAME _func_name_St_node_parse
...
#define LUMI_FUNC_NAME _func_name_St_node_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_node_analyze
...
#define LUMI_FUNC_NAME _func_name_St_node_write_block
...
#define LUMI_FUNC_NAME _func_name_St_node_write_indent_block
...
#define LUMI_FUNC_NAME _func_name_St_node_write
...
#define LUMI_FUNC_NAME _func_name_St_file_init
...
#define LUMI_FUNC_NAME _func_name_St_file_parse
...
#define LUMI_FUNC_NAME _func_name_St_file_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_file_analyze
...
#define LUMI_FUNC_NAME _func_name_St_file_write_cfile_name
...
#define LUMI_FUNC_NAME _func_name_St_file_write
Returncode St_file_write(St_file* self) {
  ...
  CHECK(214, write(&(String){23, 22, "#ifndef LUMI_MAINFILE\n"}));
  CHECK(215, write(&(String){22, 21, "#define LUMI_MAINFILE"}));
  ...
  CHECK(236, write(&(String){25, 24, "\n#undef LUMI_FILE_NAME\n\n"}));
  
  if (self->argv->length > 2) {
    CHECK(239, write(&(String){23, 22, "#ifndef LUMI_INCLUDES\n"}));
    CHECK(240, write(&(String){23, 22, "#define LUMI_INCLUDES\n"}));
  ...
  Int depth; for (depth = 0; depth < glob->max_type_depth; ++depth) {
    ...
    CHECK(251, write(&(String){26, 25, "LUMI_STAGE == LUMI_TYPES("}));
    CHECK(252, write_int(depth + 1));
    CHECK(253, write(&(String){3, 2, ")\n"}));
    CHECK(254, write(&(String){19, 18, "#undef LUMI_STAGE\n"}));
    CHECK(255, write(&(String){31, 30, "#define LUMI_STAGE LUMI_TYPES("}));
  ...
  if (self->argv->length > 2) {
    CHECK(262, write(&(String){22, 21, "#undef LUMI_INCLUDES\n"}));
...
#define LUMI_FUNC_NAME _func_name_St_root_init
...
#define LUMI_FUNC_NAME _func_name_St_root_parse
...
#define LUMI_FUNC_NAME _func_name_St_root_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_root_analyze
...
#define LUMI_FUNC_NAME _func_name_St_root_write
...
#define LUMI_FUNC_NAME _func_name_St_native_parse
...
#define LUMI_FUNC_NAME _func_name_St_native_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_native_analyze
...
#define LUMI_FUNC_NAME _func_name_St_native_write
