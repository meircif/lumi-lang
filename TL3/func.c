static char* _mr_file8_name = "func.2.lm";
#define LUMI_FILE_NAME _mr_file8_name
/* TL3 compiler - function */
...
#define LUMI_FUNC_NAME _func_name_Mfunc_init
...
#define LUMI_FUNC_NAME _func_name_Mfunc_parse
...
#define LUMI_FUNC_NAME _func_name_Mfunc_analyze
...
#define LUMI_FUNC_NAME _func_name_Mfunc_write_name
...
#define LUMI_FUNC_NAME _func_name_Mfunc_write
...
#define LUMI_FUNC_NAME _func_name_Mfunc_m_new_var
...
#define LUMI_FUNC_NAME _func_name_parse_new_mfunc
...
#define LUMI_FUNC_NAME _func_name_St_func_add_args_vars
...
#define LUMI_FUNC_NAME _func_name_St_func_parse
...
#define LUMI_FUNC_NAME _func_name_St_func_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_func_analyze
...
#define LUMI_FUNC_NAME _func_name_St_func_write
Returncode St_func_write(St_func* self) {
  ...
  CHECK(104, write(&(String){37, 36, "#if LUMI_STAGE == LUMI_DECLARATIONS\n"}));
  CHECK(105, write_spaces());
  CHECK(106, Mfunc_write(self->mfunc));
  CHECK(107, write(&(String){3, 2, ";\n"}));
  CHECK(108, write_spaces());
  CHECK(109, write(&(String){36, 35, "#elif LUMI_STAGE == LUMI_FUNCTIONS\n"}));
  ...
  CHECK(120, write(&(String){35, 34, "#define LUMI_FUNC_NAME _func_name_"}));
  ...
  CHECK(129, write(&(String){23, 22, "#undef LUMI_FUNC_NAME\n"}));
...
#define LUMI_FUNC_NAME _func_name_St_func_m_register
...
#define LUMI_FUNC_NAME _func_name_St_main_parse
...
#define LUMI_FUNC_NAME _func_name_St_main_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_main_analyze
...
#define LUMI_FUNC_NAME _func_name_St_main_write
Returncode St_main_write(St_main* self) {
  Bool _Bool4;
  CHECK(148, String_list_has(glob->test_funcs, &(_Bool4)))
  if (_Bool4) {
    CHECK(149, write(&(String){34, 33, "#if LUMI_STAGE == LUMI_FUNCTIONS\n"}));
...
#define LUMI_FUNC_NAME _func_name_St_main_m_register
...
#define LUMI_FUNC_NAME _func_name_St_format_parse
...
#define LUMI_FUNC_NAME _func_name_St_format_analyze_first
...
#define LUMI_FUNC_NAME _func_name_St_format_analyze
...
#define LUMI_FUNC_NAME _func_name_St_format_write
